...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            <div class="col-6">
                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span> Customers Tables</h4>
            </div>
            <div class="col-6">
                <a href="{{route("drivers.create")}}" class="btn btn-primary" style="float: right;">Add New</a>
            </div>
        </div>
