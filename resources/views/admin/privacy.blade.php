...
<div class="container">
    <div class="card mb-4">
        <h5 class="card-header">Privacy and Policy</h5>
        <div class="card-body">
        <div class="row">
            <!-- Custom content with heading -->
            <div class="col-lg-12 mb-12 mb-xl-0">
            <div class="mt-3">
                <form id="formAccountSettings" method="POST" action="{{ route('privacy.update', $privacy->id) }}" enctype="multipart/form-data">
                    @csrf
                                ...
                                <div class="space-around col-md-12">
                                    <div class="card mb-6">
                                        <div class="card-body">
                                            ...
                                            <input type="text" name="title_en" value="{{$privacy->title_en}}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="space-around col-md-12">
                                    <div class="card mb-6">
                                        <div class="card-body">
                                            ...
                                            <div class="... ck-editor__editable ck-editor__editable_inline ...">
                                                <textarea class="form-control" id="body" name="text" rows="12" cols="12">{{$privacy->text}}</textarea>
                                            </div>
                                        </div>
                                </div>
                                <div class="space-around col-md-12">
                                    <div class="card mb-6">
                                        <div class="card-body">
                                            ...
                                            <div class="... ck-editor__editable ck-editor__editable_inline ...">
                                                <textarea class="form-control" id="body2" name="text_en" rows="12" cols="12">{{$privacy->text_en}}</textarea>
                                            </div>
                                        </div>
                                </div>
                            </div>
